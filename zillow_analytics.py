...
s3_bucket = 'zillow-transformed-data-bucket' 
...
with DAG('zillow_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_zillow_data_var")[0]}} s3://smudgy-zillow-bucket/',
        )      
